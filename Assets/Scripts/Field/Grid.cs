...
namespace Field
{
    public class Grid
    {
        ...
        public Grid(int width, int height, Vector3 offset, float nodeSize, Vector2Int target, Vector2Int mStart)
        {
            m_Width = width;
            m_Height = height;
            ...
            m_Pathfinding = new FlowFieldPathfinding(this, target, mStart);
